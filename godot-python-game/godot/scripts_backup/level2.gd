...
const lines : Array[String] = [
	"Crie uma função para descobrir qual é a ponte segura. O código deve conter pelo menos um loop (while ou for). O número correto não pode inserido diretamente.
"
]
