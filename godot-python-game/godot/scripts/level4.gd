...
const lines : Array[String] = [
	"Para encontrar o tesouro, crie uma função que permita ao jogador falar de forma sucessiva da palavra 'ECO', de formsa a restar apenas uma letra, a solução não deve conter estruturas de repetição.
"
]
